        ...
        <nav className="bg-[#1e3a8a] text-white p-4">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link href="/reportcrime" className="hover:text-gray-200">Report Crime</Link>
              ...
              <Link href="/signin" className="bg-white text-[#1e3a8a] px-4 py-2 rounded-md hover:bg-gray-100">
                Login / Sign Up
              </Link>
            </div>
          </div>
